...
gulp.task('sass', function() {
  ...
  return gulp.src('./src/assets/scss/foundationApp.scss')
...
gulp.task('build', function(done) {
  sequence('clean', ['pages', 'sass', 'sassPlugins', 'sassMain','javascript', 'javascriptHead', 'images', 'copy'], 'styleguide', done);
});
...
gulp.task('default', ['build', 'server'], function() {
  ...
  gulp.watch(['./src/assets/scss/app.scss'], ['sass', browser.reload]);
