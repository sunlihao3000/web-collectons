...
var PATHS = {
  ...
  javascriptHead: [
    ...
    'src/assets/js/head/modernizr-2.8.3.min.js',
    'src/assets/js/head/jquery.min.js',
    'src/assets/js/head/jquery-ui.min.js',
    'src/assets/js/head/skrollr.min.js'    
  ],
