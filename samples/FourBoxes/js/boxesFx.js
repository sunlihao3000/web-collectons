...
;( function( window ) {
	...
	BoxesFx.prototype._init = function() {
		...
		this.nav.innerHTML = '<span class="prev"><i></i></span><span id="next-click" class="next"><i></i></span>';
	...
	// add by lihao --- fire the click in order it can auotplay
	...
	// fire click 10 times each 5s
	setTimeout(function(){
		var theNode = document.getElementById('next-click');
		var time = 0;
		for (var i = 0; i < 10; i++)
		{
		    time += 5000;
