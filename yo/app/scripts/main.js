...
function removeParentParentElm() {
	$('.demo').delegate('.remove_pp', 'click', function(e) {
		e.preventDefault();
...
function downloadLayoutSrc() {
	...
	t.find('.preview, .configuration, .drag, .remove,.right-icons-holder').remove();
